...
public struct MarqueeText : View {
    ...
    public var body : some View {
        ...
        let animation = Animation
            .linear(duration: Double(stringWidth) / 35)
            .delay(startDelay)
    ...
    public init(text: String, font: UIFont = .preferredFont(forTextStyle: .body), leftFade: CGFloat = 10, rightFade: CGFloat = 10, startDelay: Double, alignment: Alignment? = nil) {
        self.text = text
        self.font = font
